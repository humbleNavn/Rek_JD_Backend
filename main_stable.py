from context import generate_context_queries, generate_onet_title
...
def main():
    ...
    db_uri = "tcp://localhost:19530"  # Adjust as needed
    ...
    *Tools: Familiarity with Microsoft Office and/or Google Workspace
    ...
    # Generate Context
    contexts = generate_context_queries(user_requirement, job_title)
    
    #CONTEXT NULL TEST CASE
    #contexts = ''
